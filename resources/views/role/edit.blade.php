...
@section('page_subtitle', 'Perbarui data role (hak akses) sistem.')
            ...
            <div class="card-body p-5">
                <form action="{{ route('roles.update', $role->id) }}" method="POST">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" class="form-control form-control-lg bg-light border-0 @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $role->name) }}" placeholder="Contoh: Administrator, Kasir, Manajer" required>
                        @error('name')
