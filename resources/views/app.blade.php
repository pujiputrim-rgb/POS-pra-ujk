...
<body>
    ...
    <div class="sidebar-wrapper" id="sidebar">
        ...
        <div class="flex-grow-1 overflow-y-auto">
            ...
            <div class="sidebar-menu-section">
                <div class="sidebar-menu-title">Menu Admin</div>
                <ul class="sidebar-menu-list">
                    ...
                    <li class="sidebar-menu-item">
                        <a href="{{ route('kasir.index') }}"
                            class="sidebar-menu-link {{ request()->is('kasir*') ? 'active' : '' }}"
                            id="menu-kasir" title="Kasir POS">
                    ...
                    <li class="sidebar-menu-item">
                        <a href="{{ route('user.index') }}"
                            class="sidebar-menu-link {{ request()->is('admin/user*') ? 'active' : '' }}" id="menu-user"
                    ...
                    <li class="sidebar-menu-item">
                        <a href="{{ route('categories.index') }}"
                            class="sidebar-menu-link {{ request()->is('admin/categories*') ? 'active' : '' }}"
                            id="menu-categories" title="Categories">
                    ...
                    <li class="sidebar-menu-item">
                        <a href="{{ route('roles.index') }}"
                            class="sidebar-menu-link {{ request()->is('admin/roles*') ? 'active' : '' }}"
                            id="menu-roles" title="Role Management">
                    ...
                    <li class="sidebar-menu-item">
                        <a href="{{ route('products.index') }}"
                            class="sidebar-menu-link {{ request()->is('admin/products*') ? 'active' : '' }}"
                            id="menu-products" title="Products">
        ...
        <div class="sidebar-profile">
            <img src="{{ asset('assets/images/avatar.png') }}" alt="{{ Auth::user()->name ?? 'User' }}" class="sidebar-profile-img"
    ...
    <div class="main-wrapper">
        ...
        <div class="page-header">
            <div>
                <h1 class="page-title">@yield('page_title', 'Blank Page')</h1>
                <p class="page-subtitle">@yield('page_subtitle', 'A blank starter template page for custom extensions.')</p>
            </div>
