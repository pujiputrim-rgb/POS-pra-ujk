    ...
    <div class="sidebar-wrapper" id="sidebar">
        ...
        <div class="flex-grow-1 overflow-y-auto">
                ...
                <div class="sidebar-menu-section">
                    <div class="sidebar-menu-title">Menu Pimpinan</div>
                    <ul class="sidebar-menu-list">
                        <li class="sidebar-menu-item">
                            <a href="{{ route('pimpinan.dashboard') }}"
                                class="sidebar-menu-link {{ request()->is('pimpinan/dashboard*') ? 'active' : '' }}"
                                id="menu-pimpinan-overview" title="Dashboard">
                                <i class="bi bi-grid-fill"></i>
                                <span>Dashboard</span>
                            </a>
                        </li>
                        <li class="sidebar-menu-item">
                            <a href="{{ route('pimpinan.stok') }}"
                                class="sidebar-menu-link {{ request()->is('pimpinan/stok*') ? 'active' : '' }}"
                                id="menu-pimpinan-stok" title="Lihat Stok Barang">
                        ...
                        <li class="sidebar-menu-item">
                            <a href="{{ route('pimpinan.laporan') }}"
                                class="sidebar-menu-link {{ request()->is('pimpinan/laporan*') ? 'active' : '' }}"
                                id="menu-pimpinan-laporan" title="Laporan Penjualan">
